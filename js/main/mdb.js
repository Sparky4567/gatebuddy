								...
								},
								{
									...
									value: function (t, e) {
										var n = this,
											...
											a =
												t === pn ? "carousel-item-start" : "carousel-item-end",
											u =
												t === pn ? "carousel-item-next" : "carousel-item-prev",
											s = t === pn ? "left" : "right";
										...
										return t.concat(
											vo(e) === zr
												? ((n = f),
												  ...
												  (t = r.flipVariations),
												  (u =
														void 0 === (r = r.allowedAutoPlacements) ? Zr : r),
												  (s = Go(o)),
												  (o = s
														? t
															? Jr
								...
								t.forEach(function (t) {
									!(function (t, e) {
										...
										if (e.includes(n))
											return (
												!vi.has(n) ||
												Boolean(t.nodeValue.match(mi) || t.nodeValue.match(bi))
											);
										for (
							...
							(e = [
								...
								},
								{
									...
									value: function (t) {
										this._isEnabled &&
											(t
												? (((t = this._initializeOnDelegatedTarget(
														t
								...
								},
								{
									...
									value: function (t, e) {
										(e = this._initializeOnDelegatedTarget(t, e)),
											t &&
												(e._activeTrigger["focusin" === t.type ? Ki : zi] = !0),
									...
									value: function () {
										...
										(this._element.parentNode &&
											...
											(r = this._element.closest(".nav, .list-group")) &&
												((n =
													"UL" === r.nodeName || "OL" === r.nodeName ? ba : ma),
									...
									value: function () {
										...
										D.on(this._parent, Xs, function (t) {
											D.trigger(e._parent, Zs, {
												...
												(e._mdbPopperConfig = e._menu.getAttribute(
													"data-mdb-popper"
												));
										});
									},
